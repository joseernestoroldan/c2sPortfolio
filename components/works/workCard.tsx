...
const WorkCard = ({
  ...
  return (
    <div className="flex flex-col w-full p-8 border-dotted border-gray-500 border h-auto mx-auto relative rounded-[0px] overflow-hidden group">
      <div className="w-full aspect-video dark:bg-black gray-300 relative overflow-hidden rounded-[5px] ">
        <Image src={image} fill alt="project image" className="object-cover transition-all duration-500 group-hover:scale-105" />
      </div>
