...
const Navbar = () => {
  return (
    <div className="w-full max-w-4xl mx-auto fixed top-0 left-1/2 -translate-x-1/2 z-30">
      <div className="w-full bg-[#D6DBDC] dark:bg-gray-900"><Social/></div>
      <div className="w-full bg-[#D6DBDC] dark:bg-gray-900 py-4  flex flex-row justify-between items-center">
        <div className="w-[110px] h-[30px] relative text-white">
          <Image src={"/LogoColor.svg"} alt="code2steps logo" fill className="dark:invert-0 invert"/>
        </div>
