        ...
        <CarouselItem>
          <div className="p-1">
            <Card className=" h-[500px] sm:h-[300px] w-full max-w-5xl bg-gradient-to-br dark:from-black dark:via-gray-900 dark:to-black from-transparent via-gray-200 to-transparent">
              <CardContent className="flex h-[500px] sm:h-[300px] w-full max-w-5xl items-center justify-center bg-transparent">
                <div className="text-justify indent-6 opacity-80 text-gray-900 dark:text-white mx-auto bg-transparent">
